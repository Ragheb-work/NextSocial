        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center justify-center">
            <div className="w-full h-64 relative">
              ...
              <Image
                src={
                  "https://images.pexels.com/photos/1461441/pexels-photo-1461441.jpeg?auto=compress&cs=tinysrgb&w=600"
                }
                alt=""
                width={128}
                height={128}
            ...
            <h1 className="mt-20 mb-4 text-2xl font-medium">Martin Key</h1>
