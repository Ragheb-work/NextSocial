    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          />
          <span className="font-medium">Luck Nail</span>
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="">
          ...
          tempore quasi perferendis non excepturi laboriosam voluptatibus minima
          dignissimos quas enim corporis odit doloribus cupiditate vel a
          corrupti deleniti nesciunt.
        </p>
      </div>
        ...
        <div className="flex gap-8">
          <div className="flex items-center gap-4 bg-slate-50 p-2 rounded-xl">
            ...
            <span className="text-gray-500">
              106 <span className="hidden md:inline">Likes</span>
            </span>
          </div>
          <div className="flex items-center gap-4 bg-slate-50 p-2 rounded-xl">
            <Image
            ...
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">
              34 <span className="hidden md:inline">Comments</span>
            </span>
          </div>
        </div>
